...
export const adminController = {
  ...
  // ✅ ADD createAdminDirect HERE (at the end, before the closing })
  async createAdminDirect(req: AuthRequest, res: Response) {
    try {
      const { email, password, firstName, lastName } = req.body;
      
      console.log('📝 Creating admin directly:', { email, firstName, lastName });
